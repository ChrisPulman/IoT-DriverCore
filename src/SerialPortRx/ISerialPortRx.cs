...
/// <summary>Serial Port Rx interface.</summary>
public interface ISerialPortRx : IPortRx
{
    ...
    /// <summary>Gets or sets the new line.</summary>
    /// <value>
    /// The new line.
    /// </value>
    ...
    /// <summary>Reads the character.</summary>
    /// <returns>An integer.</returns>
    int ReadChar();

    /// <summary>Reads the existing.</summary>
    ...
    IDisposable StartDataReception();
    ...
    /// <returns>A disposable that stops the data reception when disposed.</returns>
    IDisposable StartDataReception(int pollingIntervalMs);
}
