...
internal static class TUnitAssert
{
    ...
    internal static void True(bool condition) => True(condition, null);
    ...
    /// <param name="condition">The condition to verify.</param>
    internal static void False(bool condition) => False(condition, null);
    ...
    /// <param name="actual">The actual value.</param>
    internal static void NotEqual<T>(T notExpected, T actual)
    {
    ...
    internal static void InRange<T>(T actual, T low, T high)
    ...
    internal static Exception Throws(Type exceptionType, Action action) =>
        TUnitAssertions.Throws(exceptionType, action);

    /// <summary>Asserts that an action throws the specified exception type or a derived type.</summary>
    /// <typeparam name="T">The expected exception type.</typeparam>
    /// <param name="action">The action to execute.</param>
    /// <returns>The thrown exception.</returns>
    internal static T ThrowsAny<T>(Action action)
        where T : Exception =>
