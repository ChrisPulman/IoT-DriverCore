...
{
    /// <summary>The length of the response header.</summary>
    ...
    /// <summary>The frame index containing the response byte count.</summary>
    ...
    public void Initialize(byte[] frame)
    {
        ...
        _data = new(CopyFrameData(frame, HeaderLength, ByteCount));
    }
