...
/// <value>The start address.</value>
    ...
    public override string ToString() =>
        $"Read {NumberOfPoints} " +
        $"{(FunctionCode == Modbus.ReadCoils ? "coils" : "inputs")} starting at address {StartAddress}.";
    ...
    public void ValidateResponse(IModbusMessage response)
    {
        ...
        // Best effort validation: requests for one and six coils share a byte count and pass validation.
        var expectedByteCount = (NumberOfPoints + Seven) / Eight;
