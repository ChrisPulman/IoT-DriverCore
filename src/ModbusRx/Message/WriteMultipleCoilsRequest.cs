...
{
    /// <summary>Initializes a new instance of the <see cref="WriteMultipleCoilsRequest"/> class.</summary>
        ...
        : base(slaveAddress, Modbus.WriteMultipleCoils)
    {
        ...
        ByteCount = (byte)((data.Count + Seven) / Eight);
        Data = data;
    }
...
/// <value>The start address.</value>
    ...
    /// <inheritdoc/>
    public override int MinimumFrameSize => Seven;
    ...
    public void ValidateResponse(IModbusMessage response)
    {
        ...
        {
            var msg = $"Unexpected number of points in response. Expected {NumberOfPoints}, " +
    ...
    {
        if (frame is null || frame.Length < MinimumFrameSize + frame[6])
        {
        ...
        Array.Copy(frame, Seven, data, 0, data.Length);
        Data = new(data);
    }
}
