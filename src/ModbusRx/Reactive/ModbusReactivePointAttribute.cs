...
/// <summary>Base attribute for a generated Modbus point.</summary>
/// <param name="address">The zero-based Modbus address.</param>
[AttributeUsage(AttributeTargets.Property, AllowMultiple = false, Inherited = false)]
public sealed class ModbusReactivePointAttribute(ushort address = 0) : Attribute
{
    /// <summary>Gets the zero-based Modbus address.</summary>
    public ushort Address { get; } = address;

    /// <summary>Gets or sets the number of coils or registers to read.</summary>
