...
#endif
    /// <summary>Writes observable values to TCP slave data stores.</summary>
    public sealed class ModbusTcpSlaveExtensions
    {
        /// <summary>Stores the Modbus unit identifier.</summary>
        private readonly byte _unitIdentifier;

        /// <summary>Initializes a new instance of the <see cref="ModbusTcpSlaveExtensions"/> class.</summary>
        public ModbusTcpSlaveExtensions()
            : this(1)
        {
        }
        ...
        public ModbusTcpSlaveExtensions(byte unitIdentifier)
        {
        ...
        public IObservable<ModbusTcpSlave> WriteInputRegisters(
            IObservable<ModbusTcpSlave> slave,
            ushort startAddress,
        ...
        /// <param name="valuesToWrite">The values to write.</param>
        /// <returns>Observable ModbusTcpSlave.</returns>
        public IObservable<ModbusTcpSlave> WriteHoldingRegisters(
            IObservable<ModbusTcpSlave> slave,
            ushort startAddress,
            IObservable<ushort[]> valuesToWrite)
        {
        ...
        /// <param name="valuesToWrite">The values to write.</param>
        /// <returns>Observable ModbusTcpSlave.</returns>
        public IObservable<ModbusTcpSlave> WriteCoilDiscretes(
            IObservable<ModbusTcpSlave> slave,
            ushort startAddress,
        ...
        /// <param name="valuesToWrite">The values to write.</param>
        /// <returns>Observable ModbusTcpSlave.</returns>
        public IObservable<ModbusTcpSlave> WriteInputDiscretes(
            IObservable<ModbusTcpSlave> slave,
            ushort startAddress,
            IObservable<bool[]> valuesToWrite)
        {
