...
public class ModbusMaster : ModbusDevice, IModbusMaster
{
    ...
    {
        ValidateNumberOfPoints(nameof(numberOfPoints), numberOfPoints, TwoThousand);
    ...
    {
        ValidateNumberOfPoints(nameof(numberOfPoints), numberOfPoints, OneHundredTwentyFive);
    ...
    {
        ValidateData(nameof(data), data, OneHundredTwentyThree);
    ...
    {
        ValidateData(nameof(data), data, OneThousandNineHundredSixtyEight);
    ...
    /// <param name="startWriteAddress">The zero-based holding-register address at which to begin writing.</param>
    ...
    public Task<ushort[]> ReadWriteMultipleRegistersAsync(
        ...
        ushort[] writeData)
    {
        ValidateNumberOfPoints(nameof(numberOfPointsToRead), numberOfPointsToRead, OneHundredTwentyFive);
        ValidateData(nameof(writeData), writeData, OneHundredTwentyOne);
    ...
    /// <param name="responseFactory">Creates a response message for parsing.</param>
    ...
    private Task<ushort[]> PerformReadRegistersAsync(ReadHoldingInputRegistersRequest request) =>
        RunReadRegistersAsync(request, PerformReadRegisters);
