...
""";
    ...
    {
        var reactiveType = compilation.GetTypeByMetadataName("CP.IO.Ports.Reactive.ISerialPortRx");
        var standardType = compilation.GetTypeByMetadataName("CP.IO.Ports.ISerialPortRx");

        return reactiveType is not null && standardType is null
            ? "CP.IO.Ports.Reactive"
            : "CP.IO.Ports";
    }
