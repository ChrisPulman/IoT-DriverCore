...
public sealed partial class SerialPortReactiveStreamGenerator : IIncrementalGenerator
{
    ...
    private const string AttributeMetadataName = "IoT.DriverCore.Serial.SourceGeneration.SerialPortReactiveStreamAttribute";
...
/// </summary>
internal enum SerialPortReactiveSource
{
    /// <summary>
...
internal sealed class SerialPortReactiveStreamAttribute : global::System.Attribute
{
    /// <summary>
...
""";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var compilationAndStreams = context.CompilationProvider.Combine(streamDeclarations.Collect());

        context.RegisterSourceOutput(
            compilationAndStreams,
            static (sourceProductionContext, source) => Execute(sourceProductionContext, source.Left, source.Right));
    }
    ...
    {
        var reactiveType = compilation.GetTypeByMetadataName("IoT.DriverCore.Serial.Reactive.ISerialPortRx");
        var standardType = compilation.GetTypeByMetadataName("IoT.DriverCore.Serial.ISerialPortRx");

        return reactiveType is not null && standardType is null
            ? "IoT.DriverCore.Serial.Reactive"
            : "IoT.DriverCore.Serial";
    }
