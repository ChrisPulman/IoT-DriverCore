    ...
    MitsubishiSerialOptions? Serial = null)
{
    ...
    public TimeSpan ResolvedTimeout => Timeout ?? TimeSpan.FromSeconds(MitsubishiNumericConstants.Four);
    ...
    public MitsubishiSerialOptions ResolvedSerial =>
        Serial ?? throw new InvalidOperationException("Serial transport requires Serial options.");
