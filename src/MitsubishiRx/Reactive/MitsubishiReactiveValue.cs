...
public static class MitsubishiReactiveValue
{
    ...
    public static MitsubishiReactiveValue<T> FromResponse<T>(
        Responce<T> response,
    ...
    public static MitsubishiReactiveValue<T> Heartbeat<T>(
        MitsubishiReactiveValue<T> value,
        DateTimeOffset timestampUtc)
    {
    ...
    public static MitsubishiReactiveValue<T> Stale<T>(
        MitsubishiReactiveValue<T> value,
        DateTimeOffset timestampUtc)
    {
        ArgumentNullException.ThrowIfNull(value);
