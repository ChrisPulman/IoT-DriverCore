...
internal static class NativeMethods
{
    ...
    internal static int Srv_ClearEvents(nint server) =>
        GetExport<SrvClearEventsDelegate>(nameof(Srv_ClearEvents))(server);

    /// <summary>Destroys a Snap7 server instance.</summary>
    /// <param name="server">The native server handle reference.</param>
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_Destroy(ref nint server) =>
        GetExport<SrvDestroyDelegate>(nameof(Srv_Destroy))(ref server);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_GetMask(nint server, int maskKind, ref uint mask) =>
        GetExport<SrvGetMaskDelegate>(nameof(Srv_GetMask))(server, maskKind, ref mask);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_SetMask(nint server, int maskKind, uint mask) =>
        GetExport<SrvSetMaskDelegate>(nameof(Srv_SetMask))(server, maskKind, mask);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_GetStatus(
        nint server,
        ref int serverStatus,
        ref int cpuStatus,
        ref int clientsCount) =>
        GetExport<SrvGetStatusDelegate>(nameof(Srv_GetStatus))(
            server,
            ref serverStatus,
            ref cpuStatus,
            ref clientsCount);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_SetCpuStatus(nint server, int cpuStatus) =>
        GetExport<SrvSetCpuStatusDelegate>(nameof(Srv_SetCpuStatus))(server, cpuStatus);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_PickEvent(nint server, ref USrvEvent @event, ref int eventReady) =>
        GetExport<SrvPickEventDelegate>(nameof(Srv_PickEvent))(server, ref @event, ref eventReady);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_SetRWAreaCallback(
        nint server,
        SrvRwAreaCallback callback,
        nint userDataPointer) =>
        GetExport<SrvSetRwAreaCallbackDelegate>(nameof(Srv_SetRWAreaCallback))(
            server,
            callback,
            userDataPointer);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_LockArea(nint server, int areaCode, int index) =>
        GetExport<SrvLockAreaDelegate>(nameof(Srv_LockArea))(server, areaCode, index);
    ...
    /// <param name="index">The area index.</param>
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_UnlockArea(nint server, int areaCode, int index) =>
        GetExport<SrvUnlockAreaDelegate>(nameof(Srv_UnlockArea))(server, areaCode, index);
    ...
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_RegisterArea(
        nint server,
        int areaCode,
        int index,
        nint userDataPointer,
        int size) =>
        GetExport<SrvRegisterAreaDelegate>(nameof(Srv_RegisterArea))(
            server,
            areaCode,
            index,
            userDataPointer,
    ...
    /// <param name="index">The area index.</param>
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_UnregisterArea(nint server, int areaCode, int index) =>
        GetExport<SrvUnregisterAreaDelegate>(nameof(Srv_UnregisterArea))(server, areaCode, index);
    ...
    /// <param name="userDataPointer">The user data pointer.</param>
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_SetEventsCallback(nint server, SrvCallback callback, nint userDataPointer) =>
        GetExport<SrvSetEventsCallbackDelegate>(nameof(Srv_SetEventsCallback))(
            server,
            callback,
            userDataPointer);
    ...
    /// <param name="userDataPointer">The user data pointer.</param>
    /// <returns>The Snap7 result code.</returns>
    internal static int Srv_SetReadEventsCallback(
        nint server,
        SrvCallback callback,
        nint userDataPointer) =>
        GetExport<SrvSetReadEventsCallbackDelegate>(nameof(Srv_SetReadEventsCallback))(
            server,
            callback,
            userDataPointer);
