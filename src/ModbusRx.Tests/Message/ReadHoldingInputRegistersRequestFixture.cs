...
public class ReadHoldingInputRegistersRequestFixture
{
    ...
    {
        var request = new ReadHoldingInputRegistersRequest(Modbus.ReadHoldingRegisters, Num.Value5, 1, Num.Value10);
    ...
    {
        var request = new ReadHoldingInputRegistersRequest(Modbus.ReadInputRegisters, Num.Value5, 1, Num.Value10);
