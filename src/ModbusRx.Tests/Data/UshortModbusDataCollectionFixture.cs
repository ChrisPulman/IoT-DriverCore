...
public class UshortModbusDataCollectionFixture : ModbusDataCollectionFixture<ushort>
{
    ...
    protected override ushort[] GetArray() =>
        [
            Num.Value5, Num.Value6, Num.Value7, Num.Value8, Num.Value9, Num.Value10,
            Num.Value11, Num.Value12, Num.Value13, Num.Value14, Num.Value15,
        ];

    /// <summary>Gets the non existent element.</summary>
    /// <returns>A ushort.</returns>
    protected override ushort GetNonExistentElement() => Num.Value42;
}
