...
public class ModbusTransportFixture
{
    ...
    public void Dispose_MultipleTimes_ShouldNotThrow()
    {
        ...
        streamMock.Verify(stream => stream.Dispose(), Times.Once);
    }
    ...
    {
        var request = new ReadCoilsInputsRequest(Modbus.ReadInputs, Num.Value2, Num.Value3, Num.Value4);
        var mock = new Mock<ModbusTransport>() { CallBase = true };
        var transport = mock.Object;
        ...
        _ = Assert.Throws<IOException>(
            () => transport.UnicastMessage(request, static () => new ReadCoilsInputsResponse()));
    ...
    public void UnicastMessage_ErrorSlaveException()
    {
        ...
        _ = mock.Setup(t => t.Write(It.IsNotNull<IModbusMessage>()));
        _ = mock.Setup(t => t.ReadResponseAsync(
                It.IsAny<Func<ReadCoilsInputsResponse>>())).Throws<SlaveException>();

        _ = Assert.Throws<SlaveException>(
            () => transport.UnicastMessage(request, static () => new ReadCoilsInputsResponse()));
    ...
    public void UnicastMessage_AcknowlegeSlaveException()
    {
        ...
        transport.WaitToRetryMilliseconds = Num.Value5;
    ...
    public void UnicastMessage_ReReads_IfShouldRetryReturnTrue()
    {
        ...
        _ = mock.Setup(t => t.OnShouldRetryResponse(It.IsNotNull<IModbusMessage>(), It.IsNotNull<IModbusMessage>()))
            .Returns(() =>
            {
                var result = expectedReturn[onShouldRetryResponseCallsCount];
                onShouldRetryResponseCallsCount++;
                return result;
            });
    ...
    public async Task CreateResponse_SlaveExceptionAsync()
    {
        ...
        var message = await transport.CreateResponseAsync(
            Task.FromResult(responseFrame),
    ...
    public void ShouldRetryResponse_ReturnsFalse_IfDifferentMessage()
    {
        ...
        IModbusMessage request = new ReadCoilsInputsRequest(Modbus.ReadCoils, Num.Value2, 1, 1);
    ...
    public void ValidateResponse_MismatchingFunctionCodes()
    {
        ...
        IModbusMessage response = new ReadHoldingInputRegistersResponse(
            Modbus.ReadHoldingRegisters,
            1,
    ...
    public void ValidateResponse_MismatchingSlaveAddress()
    {
        ...
        IModbusMessage request = new ReadCoilsInputsRequest(Modbus.ReadCoils, Num.Value42, 1, 1);
        IModbusMessage response = new ReadHoldingInputRegistersResponse(
            Modbus.ReadCoils,
            Num.Value33,
            new RegisterCollection());
    ...
    /// <summary>Creates an exception instance for the supplied exception type.</summary>
    ...
    private static Exception CreateException(Type exceptionType) =>
        Activator.CreateInstance(exceptionType) as Exception
            ?? throw new InvalidOperationException($"Unable to create {exceptionType.FullName}.");
}
