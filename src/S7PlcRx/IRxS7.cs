...
public interface IRxS7 : ICancelable
{
    ...
    /// <summary>Gets an observable sequence that provides error messages encountered during operation.</summary>
    ...
    /// <summary>Gets an observable sequence of the most recent error codes.</summary>
    ...
    /// <summary>Gets the type of programmable logic controller (PLC) associated with this instance.</summary>
    CpuType PLCType { get; }

    /// <summary>Gets the rack number associated with the device or connection.</summary>
    short Rack { get; }

    /// <summary>Gets the slot number associated with the current instance.</summary>
    short Slot { get; }
    ...
    /// <summary>Gets or sets a value indicating whether WatchDog writing operations are displayed.</summary>
    ...
    /// <summary>Gets or sets the value to be written to the watchdog register.</summary>
    ushort WatchDogValueToWrite { get; set; }

    /// <summary>Gets the time interval, in milliseconds, used by the watchdog for writing operations.</summary>
    int WatchDogWritingTime { get; }

    /// <summary>Gets an observable sequence that provides the current read time in ticks.</summary>
    ...
    /// <summary>Observes changes to the specified variable.</summary>
    /// <typeparam name="T">The type of the variable to observe.</typeparam>
    /// <param name="tag">The typed logical tag key to observe.</param>
    /// <returns>
    /// An observable sequence that emits the current and subsequent values of the specified variable. The value is null
    /// if the variable does not exist or has not been set.</returns>
    IObservable<T?> Observe<T>(LogicalTagKey<T> tag);

    /// <summary>Asynchronously retrieves the value of the specified variable, if it exists.</summary>
    /// <typeparam name="T">The type of the value to retrieve.</typeparam>
    /// <param name="tag">The typed logical tag key to read.</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the value of the variable if found;
    /// otherwise, null.</returns>
    Task<T?> ReadAsync<T>(LogicalTagKey<T> tag);

    /// <summary>Asynchronously retrieves a variable value with cancellation.</summary>
    /// <typeparam name="T">The type of the value to retrieve.</typeparam>
    /// <param name="tag">The typed logical tag key to read.</param>
    /// <param name="cancellationToken">A token used to cancel the operation.</param>
    /// <returns>A task containing the value when found; otherwise, null.</returns>
    Task<T?> ReadAsync<T>(LogicalTagKey<T> tag, CancellationToken cancellationToken);

    /// <summary>Sets the value of a variable with the specified name and value.</summary>
    /// <typeparam name="T">The type of the value to assign to the variable.</typeparam>
    /// <param name="variable">
    /// The name of the variable to set. Can be null to indicate an unnamed or default variable.
    /// </param>
    /// <param name="value">
    /// The value to assign to the variable. Can be null if the variable type allows null values.
    /// </param>
    void Value<T>(string? variable, T? value);

    /// <summary>Retrieves an observable sequence containing information about the system's CPU.</summary>
    ...
    /// <returns>
    /// An observable sequence of string arrays, where each array contains details about the CPU. It emits new
