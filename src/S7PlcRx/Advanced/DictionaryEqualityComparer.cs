...
/// <summary>Compares dictionaries by their key-value pairs.</summary>
...
public class DictionaryEqualityComparer<TKey, TValue> :
    IEqualityComparer<Dictionary<TKey, TValue>>, System.Collections.IEqualityComparer
    where TKey : notnull
{
    /// <summary>Determines whether two dictionaries are equal by comparing their keys and values.</summary>
    ...
    /// <returns>true if both dictionaries contain the same keys and values; false otherwise. Returns true if both
    /// are null.</returns>
    ...
    /// <summary>Returns a hash code for the specified dictionary instance.</summary>
    ...
    bool System.Collections.IEqualityComparer.Equals(object? x, object? y) =>
        Equals(x as Dictionary<TKey, TValue>, y as Dictionary<TKey, TValue>);

    int System.Collections.IEqualityComparer.GetHashCode(object obj) =>
        obj is Dictionary<TKey, TValue> dictionary ? GetHashCode(dictionary) : 0;
}
