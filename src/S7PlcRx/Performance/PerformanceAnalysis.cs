...
{
    /// <summary>Gets or sets the start time of the analysis.</summary>
    public DateTimeOffset StartTime { get; set; }

    /// <summary>Gets or sets the end time of the analysis.</summary>
    public DateTimeOffset EndTime { get; set; }

    /// <summary>Gets or sets the monitoring duration.</summary>
    public TimeSpan MonitoringDuration { get; set; }

    /// <summary>Gets or sets the tag change frequencies.</summary>
    public Dictionary<string, int> TagChangeFrequencies { get; } = [];

    /// <summary>Gets or sets the total tag changes observed.</summary>
    public int TotalTagChanges { get; set; }

    /// <summary>Gets or sets the average changes per tag.</summary>
