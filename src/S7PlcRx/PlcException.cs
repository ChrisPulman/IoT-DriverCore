...
{
    /// <summary>Initializes a new instance of the <see cref="PlcException"/> class.</summary>
    public PlcException()
        : this(ErrorCode.NoError, "PLC communication failed.")
    {
    }
    ...
    public PlcException(string? message)
        : this(ErrorCode.NoError, message)
    {
    }
    ...
    public PlcException(string? message, Exception? innerException)
        : this(ErrorCode.NoError, message, innerException)
    {
    }
