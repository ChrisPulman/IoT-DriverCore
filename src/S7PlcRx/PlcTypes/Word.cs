...
public static class Word
{
    ...
    /// <summary>Creates a 16-bit unsigned integer from a byte array starting at the specified index.</summary>
    ...
    /// <summary>Creates a 16-bit unsigned integer from a span containing two bytes in little-endian order.</summary>
    ...
    /// exception.</remarks>
    /// <param name="bytes">A read-only span of bytes that provides the two bytes to convert. The span must
    ...
    /// <remarks>The resulting value is calculated as (highValue * 256) + lowValue, with lowValue as the least
    /// significant byte and highValue as the most significant byte. This method assumes a little-endian byte
    /// order.</remarks>
    ...
    /// <returns>An array of 16-bit unsigned integers representing the converted values from the input byte
    /// array.</returns>
    ...
    /// <returns>An array of 16-bit unsigned integers parsed from the input bytes. The length of the array is
    /// half the length of
    ...
    /// <param name="destination">The array that will receive the bytes representing the value. Must have
    ...
    /// <summary>Writes the specified 16-bit unsigned integer to the provided span in big-endian byte order.</summary>
    ...
    /// <param name="destination">The span of bytes that receives the converted values. Must be at least twice
