...
/// <summary>Maps a member to an S7 string with a reserved length.</summary>
...
public sealed class S7StringAttribute : Attribute
{
    ...
    /// <summary>Initializes a new instance of the <see cref="S7StringAttribute"/> class.</summary>
    /// <param name="type">The type of S7 string to use. Must be a defined value of the S7StringType
    /// enumeration.</param>
    /// <param name="reservedLength">The reserved length for the string. Specifies the maximum number of
    /// characters the string can hold.</param>
    /// <exception cref="ArgumentException">Thrown if the specified type is not a valid value of the
    /// S7StringType enumeration.</exception>
    public S7StringAttribute(S7StringType type, int reservedLength)
    {
        if (type == S7StringType.None || !Enum.IsDefined(type))
        {
    ...
    /// <summary>Gets the type of the S7 string represented by this instance.</summary>
    public S7StringType Type { get; }

    /// <summary>Gets the number of characters reserved for the value.</summary>
    public int ReservedLength { get; }

    /// <summary>Gets the total bytes reserved for the string.</summary>
