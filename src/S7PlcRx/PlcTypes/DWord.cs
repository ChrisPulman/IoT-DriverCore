...
public static class DWord
{
    ...
    /// <param name="bytes">The byte array containing the bytes to convert. Must contain at least four bytes
    ...
    /// <summary>Reads an unsigned 32-bit value from bytes at an index.</summary>
    ...
    /// <param name="bytes">A read-only span of bytes containing at least four bytes to convert to a 32-bit
    /// unsigned integer. The first four
    /// bytes are used in the conversion.</param>
    /// <returns>A 32-bit unsigned integer represented by the first four bytes of the span, interpreted as
    /// big-endian.</returns>
    ...
    /// <param name="v2">The second byte, which becomes the second least significant byte of the resulting
    /// value.</param>
    ...
    /// <returns>An array of 32-bit unsigned integers representing the converted values from the input byte
    /// array.</returns>
    ...
    /// <summary>Writes an unsigned 32-bit value in big-endian order.</summary>
    ...
    /// Must be at least 4 bytes in length.</param>
    ...
    /// <param name="destination">A span of bytes that receives the byte representations of the input values.
    /// Must be at least four times the
    ...
    /// contain the byte representations of all
    ...
    /// <returns>A byte array containing the binary representation of the input values. The length of the
    /// returned array is four
