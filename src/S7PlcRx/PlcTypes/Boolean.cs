...
/// <summary>Provides static methods for manipulating individual bits within a byte value.</summary>
...
{
    /// <summary>Determines whether the specified bit is set in the given byte value.</summary>
    ...
    /// <summary>Returns a copy of the value with the addressed bit set.</summary>
    ...
    /// <summary>Sets the value of a bit to 1 (true), given the address of the bit.</summary>
    /// <param name="value">The value to modify.</param>
    /// <param name="bit">The index (zero based) of the bit to set.</param>
    public static void SetBit(ref byte value, int bit) => value = (byte)((value | (1 << bit)) & 0xFF);

    /// <summary>Returns a copy of the value with the addressed bit cleared.</summary>
    /// <param name="value">The input value to modify.</param>
    ...
    /// <summary>Resets the value of a bit to 0 (false), given the address of the bit.</summary>
    /// <param name="value">The input value to modify.</param>
    /// <param name="bit">The index (zero based) of the bit to clear.</param>
