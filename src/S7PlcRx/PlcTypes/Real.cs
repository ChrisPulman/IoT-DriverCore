...
public static class Real
{
    ...
    /// <param name="bytes">A read-only span of 4 bytes representing a single-precision floating-point value
    /// in big-endian byte order.</param>
    ...
    /// <summary>Converts a float to its byte-array representation.</summary>
    ...
    /// <param name="destination">The span of bytes that receives the 4-byte big-endian representation of the
    ...
    /// <param name="destination">The destination span to which the byte representations of the values are
    /// written. Must be at least four times
    ...
    /// <param name="bytes">The byte array containing the binary representation of the floating-point values.
    /// The length must be a multiple
    /// of 4.</param>
    ...
    /// <param name="bytes">The read-only span of bytes to convert. The length must be a multiple of 4, as
    /// each float consists of 4 bytes.</param>
