...
public class Tag : ITag
{
    ...
    /// <summary>Gets or sets the address associated with the entity.</summary>
    public string? Address { get; set; }

    /// <summary>Gets or sets the name associated with the object.</summary>
    public string? Name { get; set; }

    /// <summary>Gets or sets the value associated with this instance.</summary>
    public object? Value { get; set; }

    /// <summary>Gets the new value associated with the change event.</summary>
    public object? NewValue { get; internal set; }

    /// <summary>Gets the runtime type information associated with the current instance.</summary>
    public Type Type { get; internal set; }

    /// <summary>Gets the length of the array, if known.</summary>
    public int? ArrayLength { get; internal set; }

    /// <summary>Gets a value indicating whether polling operations should be suppressed for this instance.</summary>
    public bool DoNotPoll { get; internal set; }

    /// <summary>Sets a value indicating whether polling operations should be disabled.</summary>
