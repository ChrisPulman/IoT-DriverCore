...
public enum ErrorCode
{
    ...
    /// <summary>The wrong CPU type.</summary>
    WrongCPUType = 1,

    /// <summary>The connection error.</summary>
    ConnectionError = 2,

    /// <summary>The IP address not available.</summary>
    IPAddressNotAvailable,

    /// <summary>The wrong variable format.</summary>
    WrongVarFormat = 10,

    /// <summary>The wrong number received bytes.</summary>
    WrongNumberReceivedBytes = 11,

    /// <summary>The send data.</summary>
    SendData = 20,
