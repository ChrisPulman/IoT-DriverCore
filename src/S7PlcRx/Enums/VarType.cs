...
/// <summary>Specifies a supported Siemens S7 variable type.</summary>
...
{
    /// <summary>Represents a single binary digit, which can have a value of 0 or 1.</summary>
    Bit,
    ...
    /// <summary>Represents a single word in a text or document.</summary>
    Word,

    /// <summary>Represents a 32-bit unsigned integer value, commonly referred to as a double word (DWORD).</summary>
    ...
    /// <summary>Represents a double-width integer value for high-precision arithmetic operations.</summary>
    ...
    /// <summary>Represents a real number value.</summary>
    Real,

    /// <summary>Represents a double-precision floating-point value.</summary>
    LReal,

    /// <summary>Represents text as a sequence of Unicode characters.</summary>
    ...
    /// <summary>Represents a string encoded in the Siemens S7 PLC string format.</summary>
    ...
    /// <summary>Represents a Siemens S7 wide (Unicode) string value used for communication with S7 PLCs.</summary>
    ...
    /// <summary>Represents a timer that executes a callback method at specified intervals.</summary>
    ...
    /// <summary>Represents a PLC counter.</summary>
    Counter,
    ...
    /// <summary>IEC date (legacy) variable type.</summary>
    Date,

    /// <summary>Represents an extended Siemens S7 date and time value.</summary>
    ...
    /// <summary>S7 TIME variable type - serialized as S7 DInt and deserialized as C# TimeSpan.</summary>
    Time,
}
